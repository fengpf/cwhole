...
${OBJECTDIR}/adder.o: adder.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/adder.o adder.c
...
${OBJECTDIR}/csapp.o: csapp.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/csapp.o csapp.c

${OBJECTDIR}/echo.o: echo.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/echo.o echo.c

${OBJECTDIR}/hostinfo.o: hostinfo.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hostinfo.o hostinfo.c
...
${OBJECTDIR}/server.o: server.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/server.o server.c

${OBJECTDIR}/tiny.o: tiny.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tiny.o tiny.c
...
${TESTDIR}/tests/simple.o: tests/simple.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/simple.o tests/simple.c
...
${OBJECTDIR}/adder_nomain.o: ${OBJECTDIR}/adder.o adder.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/adder_nomain.o adder.c;\
	else  \
...
${OBJECTDIR}/client_nomain.o: ${OBJECTDIR}/client.o client.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/client_nomain.o client.c;\
	else  \
...
${OBJECTDIR}/csapp_nomain.o: ${OBJECTDIR}/csapp.o csapp.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/csapp_nomain.o csapp.c;\
	else  \
...
${OBJECTDIR}/echo_nomain.o: ${OBJECTDIR}/echo.o echo.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/echo_nomain.o echo.c;\
	else  \
...
${OBJECTDIR}/hostinfo_nomain.o: ${OBJECTDIR}/hostinfo.o hostinfo.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hostinfo_nomain.o hostinfo.c;\
	else  \
...
${OBJECTDIR}/server_nomain.o: ${OBJECTDIR}/server.o server.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/server_nomain.o server.c;\
	else  \
...
${OBJECTDIR}/tiny_nomain.o: ${OBJECTDIR}/tiny.o tiny.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tiny_nomain.o tiny.c;\
	else  \
